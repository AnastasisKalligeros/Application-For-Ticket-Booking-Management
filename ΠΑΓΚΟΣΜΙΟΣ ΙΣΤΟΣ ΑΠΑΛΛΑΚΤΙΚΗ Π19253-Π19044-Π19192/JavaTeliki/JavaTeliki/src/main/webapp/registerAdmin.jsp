...
<head>
	...
	<title>Λειτουργίες Διαχειριστή - Προσθήκη Διαχειριστή Εφαρμογής</title>
</head>
<body>
	...
	<div class="container">
		<h1>ΠΡΟΣΘΗΚΗ ΔΙΑΧΕΙΡΙΣΤΗ ΕΦΑΡΜΟΓΗΣ</h1>
	</div>
	...
	<div class="container">
		<form action="admin" method="post">
			...
			<div class=" form-group row">
				<label for="ID" class="col-sm-2 col-form-label">ID Διαχειριστή Εφαρμογής:</label>
				<div class="col-sm-7">
			...
			<button type="submit" class="btn btn-primary">ΠΡΟΣΘΗΚΗ ΔΙΑΧΕΙΡΙΣΤΗ ΕΦΑΡΜΟΓΗΣ</button>
		</form>
	</div>
