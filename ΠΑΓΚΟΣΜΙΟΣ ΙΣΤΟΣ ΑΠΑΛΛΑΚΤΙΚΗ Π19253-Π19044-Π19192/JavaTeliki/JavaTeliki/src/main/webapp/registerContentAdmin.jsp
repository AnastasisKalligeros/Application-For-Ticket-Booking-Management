...
<head>
	...
	<title>Λειτουργίες Διαχειριστή - Προσθήκη Διαχειριστή Περιεχομένου</title>
</head>
<body>
	...
	<div class="container">
		<h1>ΠΡΟΣΘΗΚΗ ΔΙΑΧΕΙΡΙΣΤΗ ΠΕΡΙΕΧΟΜΕΝΟΥ</h1>
	</div>
	
	<div class="container">
		<form action="admin" method="post" >
			<input type="hidden" name="action" value="addContentAdmin" />
			...
			<div class=" form-group row">
				<label for="ID" class="col-sm-2 col-form-label">ID Διαχειριστή Περιεχομένου:</label>
				<div class="col-sm-7">
					<input type="number" class="form-control" id="ID" name="ID" required="required" placeholder="Numbers only" />
				</div>
			</div>
        ...
        <button type="submit" class="btn btn-primary">ΠΡΟΣΘΗΚΗ ΔΙΑΧΕΙΡΙΣΤΗ ΠΕΡΙΕΧΟΜΕΝΟΥ</button>
